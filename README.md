...
Порядок дейтсвий пользоватля по получению конвертированного в звуковой формат PDF файла (по сути, описывает
все процессы при нормальном развитии событий):
...
в базе данных.
4. Выполняется проверка Access token микросервиса AuthServer. При первом обращении он отсутствует. AuthServer 
